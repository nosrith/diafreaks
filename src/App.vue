      ...
      <span id="nav-pane-buttons">
        <span id="nav-pane-buttons-left">
          <span class="nav-pane-item" v-if="enableSwitchEditMode">
            <b-tooltip :label="$t('message.editButtonTooltip')" type="is-light">
              <b-button
                ...
                size="medium"
                :class="context.state.editMode ? 'is-selected' : ''"
          ...
          <span class="nav-pane-item" v-if="context.state.editMode">
            <b-tooltip :label="$t('message.undoButtonTooltip')" type="is-light">
              <b-button
                icon-left="undo"
                size="medium"
                :disabled="!context.history.undoable"
          ...
          <span class="nav-pane-item" v-if="context.state.editMode">
            <b-tooltip :label="$t('message.redoButtonTooltip')" type="is-light">
              <b-button
                icon-left="redo"
                size="medium"
                :disabled="!context.history.redoable"
          ...
          <span class="nav-pane-item" v-if="context.state.editMode">
            <b-tooltip
              :label="
                Object.keys(context.diagram.trains).length > 0
                  ? $t('message.vanishTrainsButtonTooltip')
                  : $t('message.vanishStationsButtonTooltip')
              "
              type="is-light"
            >
              <b-button
                icon-left="vanish"
                size="medium"
                @click="onVanishButtonClick"
              ></b-button>
            </b-tooltip>
          </span>
          <span class="nav-pane-item">
            <b-tooltip
              :label="$t('message.uploadButtonTooltip')"
              type="is-light"
            >
              <b-button
                icon-left="upload"
          ...
          <span class="nav-pane-item">
            <b-tooltip
              :label="$t('message.downloadButtonTooltip')"
              type="is-light"
            >
              <b-button
                icon-left="download"
          ...
          <span class="nav-pane-item" v-if="enableSwitchEditMode">
            <b-tooltip :label="$t('message.helpButtonTooltip')" type="is-light">
              <b-button
                icon-left="help"
                size="medium"
                :class="subView == 'help' ? 'is-selected' : ''"
...
#nav-pane a.navbar-item:not(:focus),
#nav-pane a.navbar-item:not(:hover) {
  background-color: initial !important;
}
#nav-pane .button {
  border: none;
}
#nav-pane .button:focus,
#nav-pane .button.is-focused {
  border: none;
  box-shadow: none;
}
